...
// this help to convert razor page from view() or redirect() methods to string, which will contain all html content as string
// there no default similar method in asp.net core for now.
